...
import { type BookDetails, BookDetailsSchema } from "../../util/bookSchema.js";
...
search.get(
	...
	async (req, res) => {
		...
		const parsed = z.array(CategoryBooksSchema).safeParse(
