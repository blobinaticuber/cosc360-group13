...
const BOOKS: BookDetails[] = [
  ...
  },
  {
    ...
    "image": "http://books.google.com/books/content?id=7hFjDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
  ...
  },
  {
    ...
    "description": "Harry Potter begins his sixth year at Hogwarts School of Witchcraft and Wizardry in an atmosphere of uncertainty, as the magical world begins to face the fact that the evil wizard Voldemort is alive and active once again.",
    "image": "http://books.google.com/books/content?id=aOqMEAAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
  ...
  },
  {
    ...
    "description": "Harry Potter è ormai celebre: durante il primo anno alla Scuola di Magia e Stregoneria di Hogwarts ha sconfitto il terribile Voldemort, vendicando la morte dei suoi genitori e coprendosi di gloria. Ma una spaventosa minaccia incombe sulla scuola: un incantesimo che colpisce i compagni di Harry uno dopo l'altro, e che sembra legato a un antico mistero racchiuso nella tenebrosa Camera dei Segreti. Harry e i suoi amici sfideranno oscure magie e terribili mostri, parleranno con i gufi e viaggeranno in automobili volanti, in un percorso magico dal ritmo incalzante e dalla sequenza infinita, come da scatole cinesi. Età di lettura: da 10 anni.",
    "image": "http://books.google.com/books/content?id=HNQHAQAAMAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
  ...
  },
  {
    ...
    "image": "http://books.google.com/books/content?id=gCtazG4ZXlQC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
  ...
  },
  {
    ...
    "description": "Harry Potter que pensa destar un gojat ordinari, dinc un gigant de las subercilhas espeluhadas eu vieni sauvar, que sinscrivi a Hogwarts, lescòla de broishami, quapreni a har au quidditch, e ques bati en un duèl mortau. La rason HARRY POTTER QUEI UN BROISH!",
    "image": "http://books.google.com/books/content?id=LHG3OEuMjFwC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
  ...
  },
  {
    ...
    "description": "Harry Potter begins his sixth year at Hogwarts School of Witchcraft and Wizardry in an atmosphere of uncertainty, as the magical world begins to face the fact that the evil wizard Voldemort is alive and active once again.",
    "image": "http://books.google.com/books/content?id=9dbPAQAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
    "title": "Harry Potter and the Half-Blood Prince",
    "publishDate": "2006-09"
  },
  {
    ...
    "image": "http://books.google.com/books/content?id=wHlDzHnt6x0C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
