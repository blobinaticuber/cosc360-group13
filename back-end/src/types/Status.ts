//
// I didn't type all this out, it's just a reformatting of this file from the
// Go standard library:
//
// https://cs.opensource.google/go/go/+/refs/tags/go1.26.1:src/net/http/status.go;l=9
//

/**
 * An enumeration of all HTTP status codes.
 */
enum Status {
